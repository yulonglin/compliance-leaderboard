...
\begin{itemize}
  \item \textbf{EU AI Act Code of Practice:} 37 requirements covering transparency, copyright respect, fundamental rights, environmental impact, and transparency mechanisms.
...
\textbf{Model:} \texttt{google/gemini-2.5-flash} (fast, cost-effective for claim extraction)
...
Figure~\ref{fig:leaderboard} shows the interactive leaderboard grid displaying all seven frontier models scored across three frameworks. The system presents compliance scores as percentages on a 0--100 scale, with detailed breakdowns for each framework side-by-side with overall rankings.

\begin{figure}[h]
\centering
\includegraphics[width=0.9\linewidth]{figures/figure_1_leaderboard_grid.png}
\caption{Leaderboard interface showing seven frontier models with compliance scores across EU Code of Practice, STREAM ChemBio, and Lab Safety Commitments frameworks. Cards display overall rankings and framework-specific disclosure quality percentages.}
...
\caption{Framework scores across seven frontier models. Claude Opus 4.5 leads with 80.0\% overall. Lab Safety Commitments show consistently lower disclosure (56.8\% avg) compared to EU CoP (63.1\%) and STREAM (63.4\%), indicating a lab safety disclosure gap rather than biosafety-specific gap.}
...
\begin{itemize}
  ...
  \item \textbf{GPT-5-2:} OpenAI documentation (included in leaderboard; model sources in development)
  \item \textbf{Gemini 3 Pro:} Google DeepMind documentation (included in leaderboard; model sources in development)
\end{itemize}
...
\begin{itemize}
  \item EU CoP: 100\% exact agreement
...
\begin{itemize}
  \item Score 0 (Not Mentioned): Annotated
  \item Score 1 (Mentioned): Annotated
  \item Score 2 (Partial): Annotated
  \item Score 3 (Thorough): Annotated
\end{itemize}
